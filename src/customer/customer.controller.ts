...
//     const clientId = req.user.clientId; // Ensure clientId is extracted from the request user object
//     if (!clientId) {
//       throw new Error('Client information is missing from the user object');
//     }
//     return this.customerService.create(createCustomerDto, clientId);
//   }
...
//     const clientId = req.user.clientId; // Ensure clientId is extracted from the request user object
//     return this.customerService.findAll(clientId);
//   }
...
//     const clientId = req.user.clientId; // Ensure clientId is extracted from the request user object
//     return this.customerService.findOne(id, clientId);
//   }
...
//     const clientId = req.user.clientId; // Ensure clientId is extracted from the request user object
//     return this.customerService.update(id, updateCustomerDto, clientId);
//   }
...
//     const clientId = req.user.clientId; // Ensure clientId is extracted from the request user object
//     return this.customerService.remove(id, clientId);
//   }
// }
